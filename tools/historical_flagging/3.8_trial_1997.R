...
# load ORACLE 
com_tip_PR_1997 <- readRDS("~/SEFSC-SFD-CFB-TIP-Compositions/data/raw/com_tip_PR_1997_20231020.RDS")
...
save(com_tip_PR_1997_ORGANIZED,file="data/dataframes/com_tip_PR_1997_ORGANIZED.Rda") # file is saved in data folder  

# Load HISTORICAL data 
PR_historical_97 <- read.csv("data/raw/for_import_97.csv")
...
save(pr_97,file="data/dataframes/pr_97.Rda") # file is saved in data folder
...
# combine two tables
unique_dates_merge_97 <- full_join(com_tip_PR_1997_UNIQUEDATES_updated, pr_97_historical_UNIQUEDATES_updated, by = 'FINAL_DATE')
