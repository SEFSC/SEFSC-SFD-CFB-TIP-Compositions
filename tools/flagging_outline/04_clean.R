...
# Specify settings ####
tip_spp_rds <- "pr_yts_prep_tip_20240307.rds" # rds from end of 03 script
spp <- "yts"
isl <- "pr"
break_year <- 2012 
...
box_plot <- ggboxplot(
  tip_spp_glm, x = "gear", y = "length1_cm",
  color = "gear",
  ylab = "length1_cm", xlab = "gear")
box_plot
# Create density plot across years
density_plot <- ggdensity(use_gear, x = "length1_cm",
                          add = "mean", rug = TRUE,
