...
com_tip_PR_88_10 <- 
  readRDS("~/SEFSC-SFD-CFB-TIP-Compositions/data/raw/com_tip_PR_1988_2010_20231205.RDS")

# upload all yrs historically - before uploading i deleted any 
    # columns from csv that were completely NA
...
hist_89_num <- hist_89 |>
  mutate(
    AREACOUNTY = as.numeric(AREACOUNTY),
...
PR_88_10 <- com_tip_PR_88_10 |>
  select(
    ID, COUNTY_LANDED, LANDING_AREA_COUNTY_CODE, PLACE_LANDED, LANDING_AREA_PLACE_CODE,
