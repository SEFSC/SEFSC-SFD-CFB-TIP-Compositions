...
total_yr_date_comparison <- unique_dates_comparison |> 
  mutate(total_tip = sum(unique_dates_comparison$COUNT_ORACLE),
         total_historical = sum(unique_dates_comparison$COUNT_HISTORICAL),
         comparison = total_tip - total_historical)
